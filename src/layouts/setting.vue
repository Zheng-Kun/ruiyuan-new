  ...
  >
    <div class="setting-container">
      <t-form ref="form" :data="formData" label-align="left">
        ...
        <div class="setting-group-title">页面背景色</div>
        <t-color-picker
          v-model="formData.bgPageColor"
          format="HEX"
          :color-modes="['monochrome']"
          :show-primary-color-preview="false"
        />
        <div class="setting-group-title">容器背景色</div>
        <t-color-picker
          v-model="formData.bgContainerColor"
          format="HEX"
          :color-modes="['monochrome']"
          :show-primary-color-preview="false"
        />
        <div class="setting-group-title">表单输入项背景</div>
        <t-checkbox v-model="formData.inputBackgroundIsTransparent">透明</t-checkbox>
        <t-alert
          message="输入类组件的默认背景色为纯白即#ffffff，勾选透明时输入类组件背景色会与容器背景相同，当容器背景色为深色时为避免输入项颜色突兀，建议勾选此项"
        />
        <div class="setting-group-title">字体颜色</div>
        <t-color-picker
